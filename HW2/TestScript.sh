...
if [ $# -eq 2 ]; then
  ...
  echo ./buildsa --preftab 4 $1 ecoli.binary
  ./buildsa $1 ecoli_notab.binary
  ...
  echo ./querysa ecoli_notab.binary $2 naive ecoli_notab.naive
  ./querysa ecoli_notab.binary $2 naive ecoli_notab.naive
  ...
  echo ./querysa ecoli_notab.binary $2 simpaccel ecoli_notab.simpaccel
  ./querysa ecoli_notab.binary $2 simpaccel ecoli_notab.simpaccel
  ...
  echo ./buildsa --preftab $3 $1 ecoli.binary
  ./buildsa --preftab $3 $1 ecoli.binary
  echo ./querysa ecoli.binary $2 naive ecoli.naive
  ./querysa ecoli.binary $2 naive ecoli.naive
  echo ./querysa ecoli.binary $2 simpaccel ecoli.simpaccel
  ./querysa ecoli.binary $2 simpaccel ecoli.simpaccel
